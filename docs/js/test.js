...
// 	canvas.height = canvas.parentNode.clientWidth * 0.75
...
window.addEventListener('resize', function (event) {
    ...
    p5.prototype.orbitControl = function(sensitivityX, sensitivityY, sensitivityZ) {
      ...
      function setup() {
          ...
          createCanvas(view.clientHeight,view.clientWidth, WEBGL).parent('viewrgb');
          colorMode(RGB, 1);
          angleMode(DEGREES);
          camera(500, -500, 500, 0, 0, 0, 0, 1, 0);
        //   noLoop();
        ...
        function draw() {
          const x = clr.red / 255;
          const y = clr.green / 255;
          const z = clr.blue / 255;
          orbitControl(7, 7, 0)
